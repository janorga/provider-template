# ====================================================================================
# Setup Project
PROJECT_NAME := provider-personal
...
XPKGS = provider-personal
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-personal: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Personal CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Personal controllers
...
# This target prepares repo for your provider by replacing all "personal"
